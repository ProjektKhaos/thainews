...
?><!doctype html>
<html lang="<?= e(translator()->language()) ?>">
<head>
<meta charset="utf-8">
...
<script type="application/ld+json" nonce="<?= e($nonce) ?>"><?= json_encode(['@context'=>'https://schema.org','@type'=>'NewsMediaOrganization','name'=>'Thai News','url'=>absolute_url(''),'logo'=>absolute_url('img/thainews_logo1.png')],JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE|JSON_HEX_TAG|JSON_HEX_AMP) ?></script>
</head><body>
<header class="site-header">
<a class="brand" href="<?= e(url()) ?>"><img src="<?= e(asset_url('img/thainews_logo1.png')) ?>" alt="Thai News" width="1254" height="1254" fetchpriority="high"></a>
